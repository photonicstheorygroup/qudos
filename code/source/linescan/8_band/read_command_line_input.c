...
void read_command_line_input( int argc, char *argv[], int *N_shape, int *N_Gx, int *N_Gy, int *N_Gz, int *strain_region_type, int *N_S_Gx, int *N_S_Gy, int *N_S_Gz, double *T, int *piezo_order, double *Fx, double *Fy, double *Fz, int *N_grid, int *isotropic, int *include_shape_elastic_constants, int *shape_elastic_constants_order, int *softening, double *sigma_softening, int *directions, int* cross_sections, int *N_grid_cross_sections, int *directions_cross_sections, int *input_check )
{
	...
	strcpy( input_identifier[8], "T" );
	strcpy( input_identifier[9], "Fx" );
	strcpy( input_identifier[10], "Fy" );
	strcpy( input_identifier[11], "Fz" );
	strcpy( input_identifier[12], "N_line" );
	strcpy( input_identifier[13], "Isotropic" );
	strcpy( input_identifier[14], "Elastic_const" );
	strcpy( input_identifier[15], "Elastic_const_order" );
	strcpy( input_identifier[16], "Piezo" );
	strcpy( input_identifier[17], "Softening" );
	strcpy( input_identifier[18], "Sigma_softening" );
	strcpy( input_identifier[19], "Linescan_100" );
	strcpy( input_identifier[20], "Linescan_010" );
	strcpy( input_identifier[21], "Linescan_001" );
	strcpy( input_identifier[22], "Linescan_110" );
	strcpy( input_identifier[23], "Linescan_101" );
	strcpy( input_identifier[24], "Linescan_011" );
	strcpy( input_identifier[25], "Linescan_111" );
	strcpy( input_identifier[26], "Cross_sections" );
	strcpy( input_identifier[27], "N_cross" );
	strcpy( input_identifier[28], "Cross_section_100" );
	strcpy( input_identifier[29], "Cross_section_010" );
	strcpy( input_identifier[30], "Cross_section_001" );
	strcpy( input_identifier[31], "Cross_section_m110" );
	strcpy( input_identifier[32], "Cross_section_110" );
	strcpy( input_identifier[33], "Cross_section_m101" );
	strcpy( input_identifier[34], "Cross_section_0m11" );
	strcpy( input_identifier[35], "Cross_section_111" );
