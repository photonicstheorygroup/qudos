					...
					case 1:
						...
						switch( idx_row_block ) // Setting 8-band matrix element depending on row band
						{
							...
							case 1:
								...
								H[index] = E_CB( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 2:
								...
								H[index] = -1.0*sqrt( 3.0 )*T_minus( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 3:
								...
								H[index] = sqrt( 2.0 )*U( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 4:
								...
								H[index] = -1.0*U( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 7:
								...
								H[index] = -1.0*T_plus( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 8:
								...
								H[index] = -1.0*sqrt( 2.0 )*T_plus( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
					...
					case 2:
						...
						switch( idx_row_block )
						{
							...
							case 2:
								...
								H[index] = E_HH( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 3:
								...
								H[index] = sqrt( 2.0 )*S_conj( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 4:
								...
								H[index] = -1.0*S_conj( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 7:
								...
								H[index] = -1.0*R_conj( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 8:
								...
								H[index] = -1.0*sqrt( 2.0 )*R_conj( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
					...
					case 3:
						...
						switch( idx_row_block )
						{
							...
							case 3:
								...
								H[index] = E_LH( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 4:
								...
								H[index] = Q( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 5:
								...
								H[index] = T_plus( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 6:
								...
								H[index] = R_conj( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 8:
								...
								H[index] = sqrt( 3.0 )*S_conj( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
					...
					case 4:
						...
						switch( idx_row_block )
						{
							...
							case 4:
								...
								H[index] = E_SO( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 5:
								...
								H[index] = sqrt( 2.0 )*T_plus( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 6:
								...
								H[index] = sqrt( 2.0 )*R_conj( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 7:
								...
								H[index] = -1.0*sqrt( 3.0 )*S_conj( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
					...
					case 5:
						...
						switch( idx_row_block )
						{
							...
							case 6:
								...
								H[index] = -1.0*sqrt( 3.0 )*T_plus( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
					...
					case 6:
						...
						switch( idx_row_block )
						{
							...
							case 7:
								...
								H[index] = sqrt( 2.0 )*S( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
							...
							case 8:
								...
								H[index] = -1.0*S( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
					...
					case 7:
						...
						switch( idx_row_block )
						{
							...
							case 8:
								...
								H[index] = 1.0*Q( N_shape, F, idx_G_1, idx_G_2, basis, supercell, parameters );
