...
void basis_set( struct wave_vectors basis, struct supercell_geometry *geometry, int strain_region, int coulomb_region )
{
	...
	if ( strain_region == 0 && coulomb_region == 0 ) // Electronic structure supercell lengths
	{
	...
	else if ( strain_region == 1 ) // Strain supercell lengths
	{
	...
	else  // Coulomb supercell lengths
	{
